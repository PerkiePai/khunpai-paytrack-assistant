 ...
 * @param {Object} client - LINE MessagingApiClient instance
 * @param {Object} blobClient - LINE MessagingApiBlobClient instance
 */
export async function handleImage(event, client, blobClient) {
